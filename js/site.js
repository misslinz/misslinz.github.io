...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_experimentKey":"OPT-5VPWWP_OPT-K89HC",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"Q4KMAh3BQ4qNUNsdMXdprg",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"OPT-5VPWWP_OPT-K89HC",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18537,"Q4KMAh3BQ4qNUNsdMXdprg",18578,"eCQGElkrSVqkXjHjD14dBg",18609]
    },{
      "function":"__gthc",
      "vtp_trackingId":"UA-11834194-57"
    },{
  ...
  "tags":[{
      ...
      "vtp_activate":true,
      "vtp_isEmpty":true,
      "vtp_treatmentId":"Experiment_OPT-5VPWWP_OPT-K89HC:0",
      "vtp_contextIndex":0,
      "tag_id":29
    },{
      "function":"__uae",
  ...
  "rules":[
    ...
    [["if",0,2,9,13],["add",7]],
    [["if",0,2,9,14],["add",8]],
    [["if",5],["block",1,2,3,4,5,6,7,8]],
    [["if",6],["block",1,2,3,4,5,6,7,8]],
    [["if",7],["block",1,2,3,4,5,6,7,8]]]
},
"runtime":[]
...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var vd=yd;var Od={},M=null,Pd=Math.random();Od.B="GTM-5VPWWP";Od.Yb="9n1";Od.Nh="";var Qd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Rd={__paused:!0,__tg:!0},Sd;for(Sd in Qd)Qd.hasOwnProperty(Sd)&&(Rd[Sd]=!0);var Td="www.google-analytics.com/gtm.js";
var Ud=Td,Vd=Ea(""),Wd=null,Xd=null,Yd="//www.googletagmanager.com/a?id="+Od.B+"&cv=155",Zd={},$d={},ae=function(){var a=M.sequence||1;M.sequence=a+1;return a};
...
var Jh=function(a){if(Dh[a]||Fh)return;var b=F[Ih()];ua(b)&&(b("provide",a,ta),Dh[a]=!0);},Ih=function(){return F.GoogleAnalyticsObject||"ga"},Kh=function(a,b){return function(){var c=Eh(),d=c&&c.getByName&&c.getByName(a);if(d){var e=d.get("sendHitTask");d.set("sendHitTask",function(f){var h=f.get("hitPayload"),k=f.get("hitCallback"),l=0>h.indexOf("&tid="+b);l&&(f.set("hitPayload",h.replace(/&tid=UA-[0-9]+-[0-9]+/,"&tid="+
...
var Nk=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},Pk=function(a){var b=Ok(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};
var Zk=function(){},$k=function(){var a=F.gaData,b=0,c=void 0;if(a)for(var d in a)if(a.hasOwnProperty(d)&&0===d.indexOf("UA-")&&a[d].hitcount){b+=a[d].hitcount;var e=Number(a[d].first_hit);e&&(!c||e<c)&&(c=e)}return{Le:b,He:c}},Sk=function(a,b){var c,d,e,f,h,k,l,m,p;return{Db:d,Eb:c,nc:e,oc:f,hc:h,vc:k,wb:l,ed:m,vb:p}},Yk=function(a,b){b=void 0===b?"ol":b;},bl=!1,Rk,Tk,Uk,al,Vk,Wk,Xk;var cl=function(){},el=function(a){var b=dl;};var gl=function(a){if(fl(a))return a;this.h=a};gl.prototype.Ng=function(){return this.h};var fl=function(a){return!a||"object"!==Sa(a)||Ua(a)?!1:"getUntrustedUpdateValue"in a};gl.prototype.getUntrustedUpdateValue=gl.prototype.Ng;var hl=[],il=!1,jl=function(a){return F["dataLayer"].push(a)},kl=function(a){var b=M["dataLayer"],c=b?b.subscribers:1,d=0;return function(){++d===c&&a()}};function ll(a){var b=a._clear;Ca(a,function(d,e){"_clear"!==d&&(b&&He(d,void 0),He(d,e))});Wd||(Wd=a["gtm.start"]);cl();var c=a["gtm.uniqueEventId"];if(!a.event)return!1;c||(c=ae(),a["gtm.uniqueEventId"]=c,He("gtm.uniqueEventId",c));return ci(a)}
...
(void 0===F[a]||c&&!F[a])&&(F[a]=b);return F[a]},$l=function(a,b,c){return Ze(a,b,void 0===c?!0:!!c)},am=function(a,b,c){return 0===hf(a,b,c)},bm=function(a,b){if(Ig()){b&&J(b)}else Rc(a,b)},cm=function(a){return!!xl(a,"init",!1)},dm=function(a){vl(a,"init",!0)},em=function(a,b){var c=(void 0===b?0:b)?"www.google-analytics.com/gtag/js":Ud;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";P(Kg("https://","http://",c))},fm=function(a,
b){var c=a[b];return c},gm=function(a,b,c){ue&&(Va(a)||ye(c,b,a))};
var hm=ql.gh;
var im=function(a){if(!a||a.nodeType!=Node.ELEMENT_NODE)return!1;var b=a.tagName.toUpperCase();return"SCRIPT"==b||"STYLE"==b||"LINK"==b},jm=function(a,b,c){try{null==c?a.removeAttribute(b):a.setAttribute(b,c)}catch(d){return d}return null},km=function(a,b,c){var d=a.getAttribute(b);return jm(a,b,c)?8:function(){jm(a,b,d)}},nm=function(a,b,c){var d,e,f=a.ownerDocument||a.document||document;c=(c||"").toLowerCase();"after"==c?(d=a.parentNode,e=a.nextSibling):"insert"==c?(d=a,e=a.firstChild):"append"==
c?(d=a,e=null):(d=a.parentNode,e=a);if(!d||d==f)return{result:1,Tg:[]};var h=lm(b,d);mm(h,"SCRIPT");mm(h,"NOSCRIPT");var k=[];if(h.firstChild)for(var l=h.firstChild;l;){var m=l.nextSibling;k.push(l);d.insertBefore(l,e);l=m}var p=a.nextSibling;"replace"==c&&d.removeChild(a);return{result:function(){for(;0<k.length;)d.removeChild(k.pop());"replace"==c&&d.insertBefore(a,p)},Tg:k.slice()}},om={SELECT:[1,'<select multiple="multiple">',"</select>"],FIELDSET:[1,"<fieldset>","</fieldset>"],MAP:[1,"<map>",
"</map>"],OBJECT:[1,"<object>","</object>"],TABLE:[1,"<table>","</table>"],TBODY:[2,"<table><tbody>","</tbody></table>"],COLGROUP:[2,"<table><colgroup>","</colgroup></table>"],TR:[3,"<table><tbody><tr>","</tr></tbody></table>"]},lm=function(a,b){var c=0,d="",e="",f=om[b.tagName];null!=f&&(c=f[0],d=f[1],e=f[2]);var h=b.ownerDocument.createElement("div");Jc(h,Kc(d+(a||"")+e));for(var k=h;0<c;){var l=k.firstChild;if(null==l.firstChild)return b.ownerDocument.createElement("div");k=l;c--}return k},mm=
function(a,b){for(var c=a.getElementsByTagName(b),d=[],e=c.length-1;0<=e;e--){var f=c[e];f.parentNode.removeChild(f);d.push(f)}},pm=function(a){var b=null,c=null;try{b=new Function("element",a)}catch(d){c=d}return{bd:b,error:c}},tm=function(a,b,c,d,e){var f=a+"{"+(b+": "+c+(d?" !important":""))+"}";e&&(f=e+"{"+f+"}");var h=document;if(h.createStyleSheet){var k=qm(h),l=k.rules.length;k.insertRule(f,l);return function(){k.deleteRule?k.deleteRule(l):k.removeRule(l);k.insertRule("x {}",l)}}var m=rm(f,
h);sm(m,h);var p=m.parentNode;return function(){p.removeChild(m)}},um=null,qm=function(a){if(um)return um;for(var b=a.styleSheets.length-1;0<=b;b--){var c=a.styleSheets[b];if(!c.href){var d=c.ownerNode;if(d&&d.parentNode&&"HEAD"==d.parentNode.tagName)return um=c}}0==a.styleSheets.length&&a.createStyleSheet();return um=a.styleSheets[0]},rm=function(a,b){var c=(b||document).createElement("style");void 0!==c.cssText?c.cssText=a:c.innerHTML=a;return c},sm=function(a,b){var c=b||document,d=c.getElementsByTagName("head")[0];
d||(d=c.createElement("head"),c.body.parentNode.insertBefore(d,c.body));d.appendChild(a)},vm=function(a,b,c,d){if(a.style.setProperty)try{var e=a.style.getPropertyValue(b),f=a.style.getPropertyPriority(b);a.style.setProperty(b,c,d?"important":"");return function(){a.style.setProperty(b,"",f);a.style.setProperty(b,e,f)}}catch(k){}var h=a.style.cssText;a.style.cssText+=";"+(b+": "+c+(d?" !important":""))+";";return function(){a.style.cssText=h}},xm=function(a,b,c,d){if(im(a))return 7;if(b)return wm(a,
b,d);if(c&&c.parentNode){var e=a.parentNode,f=a.nextSibling;try{c.parentNode.insertBefore(a,c.nextSibling)}catch(h){return 9}return function(){e.insertBefore(a,f)}}return 4},wm=function(a,b,c){var d=a.parentNode,e=a.nextSibling;c=(c||"").toLowerCase();try{if("bottom"==c)b.appendChild(a);else if("top"==c)b.insertBefore(a,b.childNodes[0]||null);else if("before"==c)if(b.parentNode)b.parentNode.insertBefore(a,b);else return 5;else if("after"==c)if(b.parentNode)b.parentNode.insertBefore(a,b.nextSibling);
else return 5}catch(f){return 9}return function(){try{d.insertBefore(a,e)}catch(f){}}},ym=function(a,b,c){if(0<=b&&b<a.childNodes.length){var d=a.childNodes[b];if(null!=d&&d.nodeType==Node.TEXT_NODE){var e=d.nodeValue;d.nodeValue=c;return function(){d.nodeValue=e}}return 2}return 3},zm=function(a,b,c,d){c?d=c.nextSibling:d&&(c=d.previousSibling);if(null!=c&&c.nodeType==Node.TEXT_NODE){var e=c.nodeValue;c.nodeValue+=a;return function(){c.nodeValue=e}}if(null!=d&&d.nodeType==Node.TEXT_NODE){var f=d.nodeValue;
d.nodeValue=a+d.nodeValue;return function(){d.nodeValue=f}}var h=(b.ownerDocument||b.document||document).createTextNode(a);d?b.insertBefore(h,d):b.appendChild(h);return function(){b.removeChild(h)}},Am=function(a){var b=document.createElement("a");a&&(b.href=a);return b};function Em(a,b){a=String(a);b=String(b);var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c}var Fm=new Aa;function Gm(a,b){function c(h){var k=Ve(h),l=Te(k,"protocol"),m=Te(k,"host",!0),p=Te(k,"port"),r=Te(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==p||"https"==l&&"443"==p)l="web",p="default";return[l,m,p,r]}for(var d=c(String(a)),e=c(String(b)),f=0;f<d.length;f++)if(d[f]!==e[f])return!1;return!0}
...
var Nm=function(a,b,c){for(var d={},e=!1,f=0;a&&f<a.length;f++)a[f]&&a[f].hasOwnProperty(b)&&a[f].hasOwnProperty(c)&&(d[a[f][b]]=a[f][c],e=!0);return e?d:null};Jm.Wg=function(){var a=!1;return a};var Qm=function(a){if(!Om[a]){Om[a]=!0;var b=F[a]||{};F[a]=b;var c=function(e){return Pm[e]},d=b.get;b.get=d?function(e){return void 0!==Pm[e]?Pm[e]:d(e)}:c}},Rm=function(a,b,c){try{a(c,b,Od.B)}catch(d){}},Tm=function(a){Sm[a]=Sm[a]||[];return Sm[a]},Pm={},Sm={},Om={};
var Um=function(){F.gaData=F.gaData||{};return F.gaData},Vm=function(a,b){b=void 0===b?!1:b;F.gaData=F.gaData||{};var c=F.gaData,d=c.tracker_created;c.tracker_created=function(e){b&&a(e);d&&ua(d)&&d(e);b||a(e)}},Wm=function(a){var b=F[Ih()];try{if(ua(b)&&ua(b.getAll))return ya(b.getAll(),function(c){return c.get("trackingId")===a})}catch(c){console.log("Optimize: GA Exception "+c+" trackingId: "+a+" exception: "+c)}},bn=function(a,b){var c=Xm[a];if(c)J(function(){return b(c)});else{var d=Wm(a);d?
(Xm[a]=d,Ym||(Ym=d),J(function(){return b(d)})):(Zm[a]||(Zm[a]=[]),Zm[a].push(b),$m||($m=!0,Vm(function(e){var f=e.get("trackingId");if(Zm[f]){if(an[f]){an[f]=!1;var h=F[Ih()];ua(h)&&h("ga.require","_"+Od.B)}Ym||(Ym=e);Xm[f]=e;for(var k=Zm[f],l;void 0!==(l=k.shift());)l(e);Zm[f]=void 0}})))}},cn=function(a,b,c,d){var e=F[Ih()];if("data"===b.hitType&&c){var f=F.gaData,h=Number(f&&f[d]&&f[d].first_hit),k=Ha();!isNaN(h)&&k>h&&(b.queueTime=Math.min(2E3,k+100-h))}try{var l="t0"!=a.get("name")?a.get("name")+
".send":"send";e(l,b)}catch(m){console.log("Optimize: failed to send hit using tracker: "+a.name+" exception "+m)}},Xm={},Zm={},an={},Ym,$m=!1,dn=function(a,b,c){bn(a,function(d){J(function(){cn(d,b,c,a)})})},en=function(){var a=!1;Vm(function(){if(!a){var b=F[Ih()];ua(b)&&(b("ga.require","__"+Od.B),a=!0)}},!0)},fn=function(a,b,c){var d=Um(),e=d[a]=d[a]||{};(e.pending_experiments=e.pending_experiments||{})[b]=c;e.experiments=e.experiments||{};e.experiments[b]=c},gn=function(a){var b=Um()[a];return b?
b.hitcount||0:0},hn=function(a,b,c,d){if(d){var e=Se(F.location,"host");Se(Ve(d),"host")===e&&(d="")}fn(a,b,c);Vm(function(h){h.set("referrer",d?d:void 0)},!0);if(0<gn(a)){var f=Wm(a);f&&(f.set("referrer",d?d:void 0),cn(f,{hitType:"data"},!0,a))}};
var mn=function(a,b,c){function d(){f||(f=!0,!0!==jn&&(jn=!1),kn(c),Nk(Ok(),e))}dl=a;var e="GTM-5VPWWP_"+b,f=!1;Pk(e);F.google_optimize=F.google_optimize||{};var h=F.google_optimize;h["GTM-5VPWWP"]=h["GTM-5VPWWP"]||{};h["GTM-5VPWWP"].optimize_dyn=function(l){l.split(",").forEach(function(m){ln[m]=!0});jn=!0;d()};Pc(a,void 0,d);var k=Ok();F.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},kn=function(a){if(void 0!==nn){var b=nn-on,c,d;jn?c=Ha()-nn:d=Ha()-nn;el({Fh:b,dh:c,ah:d})}ln.optimize_ready=
!0;jl({event:"opt.dyn"});jl({event:"opt.js"});if(a&&0<a.length){var e={};Ok().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&jl({event:f})})}J(function(){Jh("_"+Od.B)})},Ok=function(){return F["dataLayer"]},pn=function(a,b,c,d,e,f,h){function k(q,v){v&&(r+="&"+q+"="+encodeURIComponent(v))}on=Ha();if(a||b||c){var l=void 0;if(b){var m=mg().aw;m&&(l=m[0])}if(f&&(a||c||l)){var p=1,r,t="GTM-5VPWWP_"+p++;Pk(t);an[d]=!0;bn(d,function(q){nn=Ha();a||b?(r="?id=GTM-5VPWWP",
a&&k("cid",q.get("clientId")),k("gclid",l),h&&(k("gtm_auth",""),k("gtm_preview","")),(h||a)&&k("cb",String(Math.random())),mn(r,p++,e)):kn(e);Nk(Ok(),t)})}else kn(e)}},ln={},on,nn,jn,dl;var qn=function(a,b){this.cc=a;this.zb=b};qn.prototype.toString=function(){var a=""+this.cc;1<this.zb&&(a=a+"-"+this.zb);return a};var rn=function(a,b){this.i=a;this.h=b};rn.prototype.toString=function(){return this.h+"."+this.i};
var sn=function(){var a=Ee("optimize.cookie_path",2);return g(a)?a:"/"},un=function(a,b){var c=new tn(a,b);c.kh();return c},tn=function(a,b){this.L=Math.floor(new Date/864E5);this.i=a||"auto";this.h=b||sn();this.m=new qn(mf(this.i),nf(this.h));this.C=[];this.map={}};aa=tn.prototype;aa.Mg=function(a){if(!a)return"";var b=this.cd(a);return b?b.i:""};aa.yh=function(a,b,c,d,e){var f,h;f=void 0===f?10:f;h=void 0===h?3E3:h;if(!a)return!1;void 0==b&&(b="");this.sc(a,new rn(b,c));this.eg(e);return this.hh(d,
f,h)};aa.cd=function(a){return this.map[a]};aa.Kg=function(){for(var a=0,b=0;b<this.C.length;b++)"x"!==this.cd(this.C[b]).i[0]&&a++;return a};aa.sc=function(a,b){a&&(""===b.i?this.Te(a):(this.map[a]||this.C.push(a),this.map[a]=b))};aa.Ah=function(a){for(var b=0;b<a.length;b++)this.sc(a[b][0],a[b][1])};aa.Te=function(a){var b=xa(this.C,a);0<=b&&this.C.splice(b,1);delete this.map[a]};aa.sh=function(){for(var a=[],b=0;b<this.C.length;b++){var c=this.C[b];this.map[c].h<this.L&&a.push(c)}for(var d=0;d<
a.length;d++)this.Te(a[d])};aa.Jg=function(){for(var a=[],b=0;b<this.C.length;b++){var c=this.C[b];a.push([c,this.map[c]])}return a};aa.Cg=function(){for(var a=0,b=0;b<this.C.length;b++)a=Math.max(a,this.map[this.C[b]].h);return 864E5*a};aa.toString=function(){if(0==this.C.length)return"";for(var a=[],b=0;b<this.C.length;b++){var c=this.C[b];a.push(c+"."+this.map[c].toString())}return"GAX1."+this.m.toString()+"."+a.join("!")};aa.hh=function(a,b,c){var d=new Date;this.sh();var e=this.Kg();if(e>b||
e>(a||10)&&document.cookie.replace(/(?:;\s*)?(_gaexp=[^;]+)(?:;\s*)?/,this.toString()).length>c)return!1;d.setTime(this.Cg());if("auto"!=this.i)return this.m=new qn(mf(this.i),nf(this.h)),0===hf("_gaexp",this.toString(),{path:this.h,domain:this.i,expires:d});for(var f=ef(),h=0;h<f.length;h++)if(this.m=new qn(mf(f[h]),nf(this.h)),0===hf("_gaexp",this.toString(),{path:this.h,domain:f[h],expires:d}))return!0;return!1};aa.kh=function(){var a=bf("_gaexp",this.m.cc,this.m.zb);if(a){var b=this.lh(a);b&&
this.Ah(b.Jg())}};aa.lh=function(a){for(var b=new tn(this.i,this.h),c=a.split("!"),d=0;d<c.length;d++){var e=c[d].split(".");if(3==e.length){if(isNaN(Number(e[1])))return;b.sc(e[0],new rn(e[2],Number(e[1])))}}return b};aa.eg=function(a){a=a||{};var b=0;a.hasOwnProperty("")&&!isNaN(Number(a[""]))&&(b=this.L-Da(a[""]));for(var c=0;c<this.C.length;c++){var d=this.C[c];if(a.hasOwnProperty(d)&&!isNaN(Number(a[d]))){var e=this.cd(d);e.h=Da(a[d])+b;this.sc(d,e)}}};
var vn=function(a){try{return wd(a)}catch(b){return null}},wn=function(a){if(lh)return!0;for(;a;){if(a.nextSibling)return!0;a=a.parentNode}return!1},xn=function(a,b){for(var c=vn(a.O)||[],d=[],e=0;e<c.length;e++){var f=c[e];if(!f.gtmProgressiveApplied||!f.gtmProgressiveApplied[b]){if(a.T&&!wn(f))break;d.push(f)}}return d},yn=function(a,b){return function(){a.gtmProgressiveApplied&&delete a.gtmProgressiveApplied[b]}},zn=function(a,b){a.gtmProgressiveApplied||(a.gtmProgressiveApplied={});a.gtmProgressiveApplied[b]=
!0},An=function(a,b){var c;var d=[];if(b.Z)if(b.Z.Yc)c=[{element:H.head}];else{var e=xn(b.Z,b.id),f=null;b.uc&&(f=xn(b.uc,b.id+"-t"));for(var h=0;h<e.length;h++){var k=e[h],l=void 0;if(null!=f&&(l=f.length>h?f[h]:null,!l&&!lh&&(null===b.uc.N||b.Ae+d.length<b.uc.N)))break;d.push({element:k,Eh:l})}c=d}else c=d;var m=c;if(!lh&&b.Zf&&(!a||null==b.Z.N||b.Z.N!=b.Xc+m.length))return!1;for(var p=0;p<m.length;p++){var r=m[p].element,t=m[p].Eh,q=void 0;b.Xc++;zn(r,b.id);t&&(b.Ae++,q=b.id+"-t",zn(t,q));var v=
b.fg(r,t);ua(v)&&b.Ta.push(v);b.Ta.push(yn(r,b.id));t&&q&&b.Ta.push(yn(t,q))}if(b.Z.N&&b.Z.N==b.Xc||lh)b.finished=!0;return!0},Bn=function(a){for(var b={},c=0;c<a.X.length;c++){var d=a.X[c];if(!d.Z.Yc){var e=b[d.Z.O];e||(e=b[d.Z.O]=vn(d.Z.O)||[]);for(var f=0;f<e.length;f++){var h=e[f];h.gtmProgressiveApplied&&h.gtmProgressiveApplied[d.id]||(zn(h,d.id),d.Ta.push(yn(h,d.id)))}}}},Cn=function(a){if(!a.xd){for(var b=a.ub;b<a.X.length;b++){var c=a.X[b],d=b==a.ub;if(!c.finished&&!An(d,c))break;c.finished&&
d&&a.ub++}a.X.length>a.ub?(a.za||(a.za=F.setTimeout(function(){a.za=null;Cn(a)},80)),lh||a.pd||(a.pd=function(){J(function(){Cn(a)})},Tc(H,"DOMContentLoaded",a.pd))):Bn(a)}},Dn={},En={},Fn=void 0,Gn=function(a,b,c,d){var e=Fn;if(!vd||!e)return!1;var f={id:e.id+":"+e.X.length,fg:b,Ta:[],Zf:c,Z:a,Xc:0,uc:d||null,Ae:0,finished:!1};e.X.push(f);null===a?(f.finished=!0,b(null)):Cn(e);return!0},Hn=function(a){var b=ta;try{b=tm(a,"visibility","hidden",!0)}catch(c){}return function(){ua(b)&&b.apply();b=null}},
In=function(a,b,c,d){var e=b;if(!lh&&!a.Yc){var f=Hn(a.O);nh.push(f);e=function(h,k){var l=b(h,k);f();return l}}return Gn(a,e,c,d)};function qo(){return F.gaGlobal=F.gaGlobal||{}}var ro=function(){var a=qo();a.hid=a.hid||za();return a.hid},so=function(a,b){var c=qo();if(void 0==c.vid||b&&!c.from_cookie)c.vid=a,c.from_cookie=b};var Bo=window,Co=document,Do=function(a){var b=Bo._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===Bo["ga-disable-"+a])return!0;try{var c=Bo.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(f){}for(var d=Xe("AMP_TOKEN",String(Co.cookie),!0),e=0;e<d.length;e++)if("$OPT_OUT"==d[e])return!0;return Co.getElementById("__gaOptOutExtension")?!0:!1};function Go(a){delete a.eventModel[C.qb];Io(a.eventModel)}
...
Z.a.exs=["google"],function(){(function(a){Z.__exs=a;Z.__exs.b="exs";Z.__exs.g=!0;Z.__exs.priorityOverride=0})(function(a){var b=un(a.vtp_cookieDomain,a.vtp_cookiePath).Mg(a.vtp_measurementId);if(""===b)return b;if("x"===b[0]){var c=Number(b.substring(1));if("x"===b||isNaN(c)||0>c||1E3<=c)return""}else{var d=a.vtp_sections;if(d){var e=b.split("-");if(d.length!=e.length)return"";for(var f=0;f<d.length;f++)if(0>e[f]||e[f]>=d[f])return""}}return b})}();Z.a.optua=["google"],function(){(function(a){Z.__optua=a;Z.__optua.b="optua";Z.__optua.g=!0;Z.__optua.priorityOverride=0})(function(a){dn(a.vtp_trackingId,a.vtp_hitParams,a.vtp_correctDataHit);a.vtp_gtmOnSuccess()})}();

Z.a.sel=["google"],function(){(function(a){Z.__sel=a;Z.__sel.b="sel";Z.__sel.g=!0;Z.__sel.priorityOverride=0})(function(a){return wd(a.vtp_selector)})}();
...
Z.a.exsu=["google"],function(){(function(a){Z.__exsu=a;Z.__exsu.b="exsu";Z.__exsu.g=!0;Z.__exsu.priorityOverride=0})(function(a){un(a.vtp_cookieDomain,a.vtp_cookiePath).yh(a.vtp_measurementId,a.vtp_newState,a.vtp_expirationDay,a.vtp_max,a.vtp_expirationDates)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()})}();
Z.a.ctto=["google"],function(){(function(a){Z.__ctto=a;Z.__ctto.b="ctto";Z.__ctto.g=!0;Z.__ctto.priorityOverride=0})(function(a){var b=a.vtp_isDynamic,c=X("dataLayer"),d=c&&c.hide;if(!d)return!1;var e=Od.B,f=X("document");if(void 0===f.querySelector)return!1;var h=!!f.querySelector("body");if(null!==d.end||!h)return!1;if(!b)return!0===d[e];for(var k in d)if(d.hasOwnProperty(k)&&k.startsWith(e)&&!0===d[k])return!0;return!1})}();
Z.a.dr=["google"],function(){(function(a){Z.__dr=a;Z.__dr.b="dr";Z.__dr.g=!0;Z.__dr.priorityOverride=0})(function(a){var b=a.vtp_treatmentId,c=a.vtp_activate,d=a.vtp_contentSignature,e=a.vtp_isEmpty,f=Xl("optimize.experimentCallback",1),h=a.vtp_measurementId,k=a.vtp_experimentCombination,l;if(l=c){var m=Dn[h];l=!(!m||m==b)}if(l)a.vtp_gtmOnFailure();else{var p=Xl("optimize.whitelist",1);if(p&&p[h]?p[h]===d:eh()?e:1){if(ua(f)){var r={xid:h,xvar:k,activate:c};try{f(r)}catch(N){}}var t=!1,q=!0;if(c){var v;
Dn[h]=b;var u=En[b];if(u){for(var w=u.ub=0;w<u.X.length;w++)u.X[w].finished=!1;Cn(u);v=!0}else v=!1;if(v)t=!0;else{var y=En[b];y||(y={id:b,X:[],ub:0,za:null,pd:void 0,xd:!1},En[b]=y);Fn=y}}else{var x=En[b];if(!x||x.xd)q=!1;else{for(;x.X.length;)for(var B=x.X.pop();B.Ta.length;){var A=B.Ta.pop();if(ua(A))try{A()}catch(N){}}x.xd=!0;delete En[b];q=!0}}if(q){var z=c?k:void 0;Pm[h]=z;for(var D=Tm(h),G=0;G<D.length;G++)Rm(D[G],h,z);D=Tm("");for(var L=0;L<D.length;L++)Rm(D[L],h,z)}a[t?"vtp_gtmOnFailure":
"vtp_gtmOnSuccess"]()}else a.vtp_gtmOnFailure()}})}();
Z.a.gthc=["google"],function(){(function(a){Z.__gthc=a;Z.__gthc.b="gthc";Z.__gthc.g=!0;Z.__gthc.priorityOverride=0})(function(a){var b=!1;return b?-1:gn(a.vtp_trackingId)})}();
...
Z.a.asprv=["google"],function(){(function(a){Z.__asprv=a;Z.__asprv.b="asprv";Z.__asprv.g=!0;Z.__asprv.priorityOverride=0})(function(a){var b=a.vtp_globalName,c=Xl("eventModel");b&&Qm(b);var d,e,f;c&&(d=c.name||"",e=c.callback,f=c.remove);if(e&&ua(e))if(d=String(d),!0!==f){var h=d,k=e;Tm(h).push(k);if(""!==h)void 0!==Pm[h]&&Rm(k,h,Pm[h]);else for(var l in Pm)void 0!==Pm[l]&&Rm(k,l,Pm[l])}else{var m=e,p=Tm(d),r=p.indexOf(m);0<=r&&p.splice(r,1)}a.vtp_gtmOnSuccess()})}();
...
Z.a.uae=["google"],function(){(function(a){Z.__uae=a;Z.__uae.b="uae";Z.__uae.g=!0;Z.__uae.priorityOverride=0})(function(a){var b=a.vtp_trackingId,c=a.vtp_measurementId,d=a.vtp_experimentCombination;b&&fn(b,c,d);var e=!1;if(!b||e){var f=X("gaData",{},!1);f.expId=c;f.expVar=d}a.vtp_gtmOnSuccess()})}();
